"""скрипт для полной очистки таблицы "result_info" (класс Result)
...
def script_delete_result_db():
    """тело скрипта:"""
    print("работает скрипт script_delete_result_db.py")
    ...
    print("script_delete_result_db.py работу закончил")
